...
var factory = function factory(Chip, Input) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'label', 'source', 'suggestionMatch', 'selectedPosition', 'keepFocusOnChange', 'showSuggestionsWhenValueIsSet', 'showSelectedWhenNotInSource', 'onQueryChange', 'theme', 'template']);
  ...
  Autocomplete.propTypes = {
    ...
    customMatcher: _propTypes2.default.func,
    valueDisplayField: _propTypes2.default.string
  };
