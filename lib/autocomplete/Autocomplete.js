    ...
    function Autocomplete() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        if (event.which === 13) {
          ...
          console.log(_this.state.query, _this.state.active);
    ...
    _createClass(Autocomplete, [{
      ...
      value: function renderSuggestions() {
        ...
        var suggestions = [].concat(_toConsumableArray(this.suggestions())).map(function (_ref4) {
          ...
          var className = (0, _classnames7.default)(theme.suggestion, _defineProperty({}, theme.active, _this3.state.active === key));
          var target = _this3.props.allowCreate && key === 'new' ? _this3.state.query : null;
          ...
          return _react2.default.createElement(
            ...
            _this3.props.template ? _this3.props.template(key, value) : value
          );
        });

        var className = (0, _classnames7.default)(theme.suggestions, _defineProperty({}, theme.up, this.state.direction === 'up'));
        return _react2.default.createElement(
          'ul',
      ...
      value: function renderTemplateValue(key, value) {
        var _classnames3;

        var theme = this.props.theme;

        var className = (0, _classnames7.default)(theme.templateField, (_classnames3 = {}, _defineProperty(_classnames3, theme.errored, this.props.error), _defineProperty(_classnames3, theme.disabled, this.props.disabled), _classnames3));
      ...
      value: function render() {
        ...
        var className = (0, _classnames7.default)(theme.autocomplete, _defineProperty({}, theme.focus, this.state.focus), this.props.className);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Input, _extends({}, other, {
            ref: 'input',
            className: (0, _classnames7.default)(theme.input, _defineProperty({}, theme.hidden, template && this.state.query && !this.state.focus)),
            error: error,
            label: label,
