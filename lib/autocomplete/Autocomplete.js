  ...
  var Autocomplete = function (_Component) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function renderTemplateValue(key, value) {
        ...
        var className = (0, _classnames7.default)(theme.field, (_classnames3 = {}, _defineProperty(_classnames3, theme.errored, this.props.error), _defineProperty(_classnames3, theme.disabled, this.props.disabled), _classnames3));
