  ...
  var Autocomplete = function (_Component) {
    ...
    function Autocomplete() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        if (_this.refs && _this.refs.suggestions) _this.refs.suggestions.scrollTop = 0;
        ...
        if (shouldClearQuery) {
          _this.setState({ query: '', active: '' });
          _this.unselect(_this.props.value, event);
        }
      ...
      }, _this.handleSuggestionsMouseEnter = function (event) {
        _this.setState({ showSuggestions: true });
      }, _this.handleSuggestionsMouseLeave = function (event) {
        _this.setState({ showSuggestions: false });
      }, _this.handleSuggestionsClick = function (event) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function renderSuggestions() {
          ...
          suggestions = [_react2.default.createElement(
            'li',
            {
              ...
              onMouseDown: function onMouseDown(event) {
                _this3.select(event, _this3.state.query);
              },
        ...
        return _react2.default.createElement(
          'ul',
          { ref: 'suggestions', className: className, onMouseEnter: this.handleSuggestionsMouseEnter, onMouseLeave: this.handleSuggestionsMouseLeave, onMouseDown: this.handleSuggestionsClick },
          suggestions
        );
      }
    }, {
      ...
      value: function render() {
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'label', 'source', 'suggestionMatch', 'selectedPosition', 'showSuggestionsWhenValueIsSet', 'theme', 'template']);
        ...
        var renderTemplate = template && this.source().get(this.props.value) && !this.state.focus;
        return _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(Input, _extends({}, other, {
            ref: 'input',
            className: (0, _classnames8.default)(theme.input, _defineProperty({}, theme.hidden, renderTemplate)),
            error: error,
            label: label,
