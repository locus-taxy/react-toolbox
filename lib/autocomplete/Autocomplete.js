    ...
    _createClass(Autocomplete, [{
      ...
      value: function renderSuggestions() {
        ...
        var suggestions = [].concat(_toConsumableArray(this.suggestions())).map(function (_ref8) {
          ...
          var className = (0, _classnames6.default)(theme.suggestion, _defineProperty({}, theme.active, _this3.state.active === key));
        ...
        return _react2.default.createElement(
          'ul',
          {
            className: (0, _classnames6.default)(theme.suggestions, _defineProperty({}, theme.up, this.state.direction === 'up')),
      ...
      value: function render() {
        ...
        var showSelectedWhenNotInSource = _props.showSelectedWhenNotInSource;
        var onQueryChange = _props.onQueryChange;
        var theme = _props.theme;

        var other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'label', 'source', 'suggestionMatch', 'selectedPosition', 'keepFocusOnChange', 'showSuggestionsWhenValueIsSet', 'showSelectedWhenNotInSource', 'onQueryChange', 'theme']);

        var className = (0, _classnames6.default)(theme.autocomplete, _defineProperty({}, theme.focus, this.state.focus), this.props.className);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Input, _extends({}, other, {
            className: (0, _classnames6.default)(theme.input, _defineProperty({}, theme.hidden, renderTemplate)),
            ref: function ref(node) {
