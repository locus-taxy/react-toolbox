  ...
  var Autocomplete = function (_Component) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function renderSuggestions() {
        ...
        var className = (0, _classnames6.default)(theme.suggestions, _defineProperty({}, theme.up, this.state.direction === 'up'));
        return _react2.default.createElement(
          'ul',
      ...
      value: function renderTemplateValue(value) {
        ...
        var className = (0, _classnames6.default)(theme.templateField, (_classnames3 = {}, _defineProperty(_classnames3, theme.errored, this.props.error), _defineProperty(_classnames3, theme.disabled, this.props.disabled), _classnames3));
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Input, _extends({}, other, {
            ref: 'input',
            className: (0, _classnames6.default)(theme.input),
            error: error,
            label: label,
