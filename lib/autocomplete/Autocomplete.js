    ...
    _createClass(Autocomplete, [{
      ...
      value: function renderSuggestions() {
        ...
        var suggestions = [].concat(_toConsumableArray(this.suggestions())).map(function (_ref4) {
          ...
          if (_this3.state.query.trim() == key) {
        ...
        var customClassName = (0, _classnames7.default)(theme.suggestion, _defineProperty({}, theme.active, this.state.active === this.state.query));
      ...
      value: function renderTemplateValue(value) {
        ...
        var className = (0, _classnames7.default)(theme.templateField, (_classnames4 = {}, _defineProperty(_classnames4, theme.errored, this.props.error), _defineProperty(_classnames4, theme.disabled, this.props.disabled), _classnames4));
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(Input, _extends({}, other, {
            ref: 'input',
            className: (0, _classnames7.default)(theme.input),
            error: error,
            label: label,
