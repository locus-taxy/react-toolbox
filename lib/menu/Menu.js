  ...
  var Menu = function (_Component) {
    ...
    function Menu() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Menu.__proto__ || Object.getPrototypeOf(Menu)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        rippled: false
      }, _this.handleDocumentClickTimeoutId = null, _this.handleDocumentClick = function (event) {
    ...
    _createClass(Menu, [{
      ...
      value: function componentWillUpdate(nextProps, nextState) {
        ...
        if (!this.state.active && nextState.active) {
          ...
          this.handleDocumentClickTimeoutId = setTimeout(function () {
            _utils.events.addEventsToDocument({
              click: _this4.handleDocumentClick,
              touchstart: _this4.handleDocumentClick
            });
          }, 0);
        }
      }
      ...
      value: function renderItems() {
        ...
        return _react2.default.Children.map(this.props.children, function (item) {
          if (!item) return item;
          if ((0, _react3.isComponentOfType)(MenuItem, item)) {
            return _react2.default.cloneElement(item, {
              ripple: item.props.ripple || _this5.props.ripple,
              selected: typeof item.props.value !== 'undefined' && _this5.props.selectable && item.props.value === _this5.props.selected,
              onClick: _this5.handleSelect.bind(_this5, item)
            });
          } else {
            return _react2.default.cloneElement(item);
          }
