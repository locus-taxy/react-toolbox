  ...
  var IconMenu = function (_Component) {
    ...
    _createClass(IconMenu, [{
      ...
      value: function render() {
        ...
        var iconRipple = _props.iconRipple;
        var menuRipple = _props.menuRipple;
        ...
        var other = _objectWithoutProperties(_props, ['children', 'className', 'icon', 'iconRipple', 'menuRipple', 'onHide', 'onSelect', 'onShow', 'position', 'selectable', 'selected', 'theme']);
