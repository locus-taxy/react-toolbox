...
var factory = function factory(Tab, TabContent, FontIcon) {
  var Tabs = function (_Component) {
    ...
    _createClass(Tabs, [{
      ...
      key: 'scrollToTab',
      value: function scrollToTab(idx) {
        var activeHeader = this.navigationNode && this.navigationNode.children[idx];
        if (activeHeader && this.navigationNode) {
          ...
          var _ref2 = hasRightArrow ? this.rightArrow.getBoundingClientRect() : { width: 0 },
              rightArrowWidth = _ref2.width;

          var _ref3 = hasLeftArrow ? this.leftArrow.getBoundingClientRect() : { width: 0 },
              leftArrowWidth = _ref3.width;

          var activeTab = activeHeader.getBoundingClientRect();
          var nav = this.navigationNode.getBoundingClientRect();
      ...
      value: function render() {
        ...
        var _state$arrows2 = this.state.arrows,
            hasLeftArrow = _state$arrows2.left,
            hasRightArrow = _state$arrows2.right;
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            hasLeftArrow && _react2.default.createElement(
              'div',
              { className: theme.arrowContainer, onClick: this.scrollRight, ref: function ref(node) {
                  _this5.leftArrow = node;
                } },
            ...
            hasRightArrow && _react2.default.createElement(
              'div',
              { className: theme.arrowContainer, onClick: this.scrollLeft, ref: function ref(node) {
                  _this5.rightArrow = node;
                } },
