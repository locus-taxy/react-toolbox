  ...
  var DatePicker = function (_Component) {
    ...
    _createClass(DatePicker, [{
      ...
      value: function render() {
        ...
        var enabledDates = _props.enabledDates;
        ...
        var others = _objectWithoutProperties(_props, ['active', 'onDismiss', 'autoOk', 'cancelLabel', 'enabledDates', 'disabledDates', 'inputClassName', 'inputFormat', 'locale', 'maxDate', 'minDate', 'okLabel', 'onEscKeyDown', 'onOverlayClick', 'readonly', 'sundayFirstDayOfWeek', 'value']);
