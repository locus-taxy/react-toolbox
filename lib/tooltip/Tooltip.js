...
var tooltipFactory = function tooltipFactory() {
  ...
  var _defaults$options = _extends({}, defaults, options),
      ...
      defaultHideOnHover = _defaults$options.hideOnHover,
      defaultHideDelay = _defaults$options.hideDelay,
      defaultTooltipClassName = _defaults$options.tooltipClassName;
      ...
      _createClass(TooltippedComponent, [{
        ...
        value: function render() {
          ...
          var _props = this.props,
              ...
              tooltipHideOnHover = _props.tooltipHideOnHover,
              tooltipClassName = _props.tooltipClassName,
              other = _objectWithoutProperties(_props, ['children', 'className', 'theme', 'tooltip', 'tooltipDelay', 'tooltipHideOnClick', 'tooltipPosition', 'tooltipHideOnHover', 'tooltipClassName']);
