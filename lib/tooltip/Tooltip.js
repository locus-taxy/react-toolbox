      ...
      _createClass(TooltippedComponent, [{
        ...
        value: function deactivate() {
          ...
          if (this.state.active) {
            // #TODO check if this.tooltipNode
        ...
        value: function render() {
          ...
          var _props = this.props,
              ...
              other = _objectWithoutProperties(_props, ['children', 'className', 'theme', 'onClick', 'onMouseEnter', 'onMouseLeave', 'tooltip', 'tooltipDelay', 'tooltipHideOnClick', 'tooltipPosition', 'tooltipShowOnClick', 'tooltipHideOnHover', 'tooltipClassName']);
