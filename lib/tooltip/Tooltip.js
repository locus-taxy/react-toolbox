...
var tooltipFactory = function tooltipFactory() {
  ...
  var defaultHideOnHover = _defaults$options.hideOnHover;
  var defaultHideDelay = _defaults$options.hideDelay;
  var defaultTooltipClassName = _defaults$options.tooltipClassName;
  ...
  return function (ComposedComponent) {
    var TooltippedComponent = function (_Component) {
      ...
      function TooltippedComponent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TooltippedComponent.__proto__ || Object.getPrototypeOf(TooltippedComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          ...
          if (_this.props.tooltipHideOnHover) {
            _this.deactivate();
          } else {
            // if we don't want to hide tooltip on hover
            // give timeout
            if (_this.hoverTimeout) clearTimeout(_this.hoverTimeout);
            _this.hoverTimeout = setTimeout(function () {
              if (!_this.state.tooltipHovered) {
                //check if the mouse enterd the tooltip
                _this.deactivate();
              }
            }, _this.props.tooltipHideDelay);
          }

          if (_this.props.onMouseLeave) _this.props.onMouseLeave(event);
        }, _this.handleTooltipMouseEnter = function (event) {
          if (!_this.props.tooltipHideOnHover) {
            _this.setState({ tooltipHovered: true });
          }
        }, _this.handleTooltipMouseLeave = function (event) {
          if (!_this.props.tooltipHideOnHover) {
            _this.setState({ tooltipHovered: false }, function () {
              _this.deactivate();
            });
          }
      ...
      _createClass(TooltippedComponent, [{
        ...
        value: function deactivate() {
          ...
          if (this.state.active) {
            if (this.refs && this.refs.tooltip) _events2.default.addEventListenerOnTransitionEnded(this.refs.tooltip, this.onTransformEnd);
        ...
        value: function render() {
          ...
          var tooltipHideOnHover = _props.tooltipHideOnHover;
          var tooltipClassName = _props.tooltipClassName;
          var tooltipShowOnClick = _props.tooltipShowOnClick;

          var other = _objectWithoutProperties(_props, ['children', 'className', 'theme', 'tooltip', 'tooltipDelay', 'tooltipHideOnClick', 'tooltipPosition', 'tooltipHideOnHover', 'tooltipClassName', 'tooltipShowOnClick']);

          var _className = (0, _classnames3.default)(theme.tooltip, tooltipClassName, (_classnames = {}, _defineProperty(_classnames, theme.tooltipActive, active), _defineProperty(_classnames, theme[positionClass], theme[positionClass]), _classnames));
          ...
          return _react2.default.createElement(
            ...
            visible && _react2.default.createElement(
              ...
              tooltip !== null ? _react2.default.createElement(
                'span',
                { ref: 'tooltip', onMouseEnter: this.handleTooltipMouseEnter, onMouseLeave: this.handleTooltipMouseLeave, className: _className, 'data-react-toolbox': 'tooltip', style: { top: top, left: left } },
    ...
    TooltippedComponent.propTypes = {
      ...
      tooltipHideOnHover: _react.PropTypes.bool,
      tooltipHideDelay: _react.PropTypes.number,
